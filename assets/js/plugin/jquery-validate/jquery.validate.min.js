...
! function (a) {
    a.extend(a.fn, {
        ...
        "messages": {
            ...
            "email": "Instroduza um email válido",
            "url": "Instroduza um URL válido",
            ...
            "creditcard": "Instroduza um cartão de crédito válido",
            "equalTo": "Introduza um valor igual",
            "maxlength": a.validator.format("Tamanho máximo são {0} caractéres"),
            "minlength": a.validator.format("Tamanho minimo são {0} caractéres"),
            "rangelength": a.validator.format("Introduza um valor entre {0} e {1} caractéres"),
            "range": a.validator.format("Introduza um valor entre {0} e {1}"),
            "max": a.validator.format("Introduza um valor menor ou igual a {0}"),
            "min": a.validator.format("Introduza um valor maior ou igual a {0}")
        },
        "autoCreateRanges": !1,
        "prototype": {
            "init": function () {
